                    ...
                    case 0:
                        ...
                        if (!magicLightProbes.useVolumeBottom)
                        {
                            ...
                            else
                            {
                                ...
                                EditorGUILayout.HelpBox("Before starting the calculation, you must specify the keywords " +
                                    "for determining the algorithms of floor, ground and other levels below which the probes " +
                                    "should not be placed.", MessageType.Error);
                            ...
                            GameObject newGroundObject = null;

                            if (GUILayout.Button("Add Object"))
                            {
                                EditorGUIUtility.ShowObjectPicker<GameObject>(newGroundObject, true, "", 2);
                            }
                            ...
                            if (Event.current.commandName == "ObjectSelectorClosed")
                            {
                                ...
                                newGroundObject = EditorGUIUtility.GetObjectPickerObject() as GameObject;
            ...
            switch (selectedTab)
            {
                ...
                case 1:
                    ...
                    if (GUILayout.Button("Calculate All Volumes"))
                    {
                        ...
                        for (int i = 0; i < allGroups.Count; i++)
                        {
                            if (allGroups[i].groundAndFloorKeywords.Count == 0)
                            {
                ...
                case 3:
                    ...
                    GUILayout.Label("Global Bounds Dispaly Mode", GUILayout.MinWidth(150));
