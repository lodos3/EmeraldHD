...
namespace MagicLightProbes
{
    ...
    public class MLPLightEditor : Editor
    {
        ...
        public SerializedProperty calculationType;
        ...
        private void InitSerializedProperties()
        {
            ...
            calculationType = serializedObject.FindProperty("calculationType");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!(parentVolume.objectReferenceValue as MagicLightProbes).calculatingVolume)
            {
                ...
                GUILayout.Label("Calculation Type", GUILayout.Width(152));
                EditorGUILayout.PropertyField(calculationType, GUIContent.none);
                    ...
                    if (accurateTrace.boolValue)
                    {
                        ...
                        switch (lightType.intValue)
                        {
                            ...
                            case (int) MLPLight.MLPLightType.Mesh:
                                ...
                                {
                                    case (int) MLPLight.TracePointSettingType.Auto:
                                        ...
                                        break;
                                    case (int) MLPLight.TracePointSettingType.Custom:
                                        MLPLightShowCustomTracePoints();
                                        break;
                                }
                                break;
